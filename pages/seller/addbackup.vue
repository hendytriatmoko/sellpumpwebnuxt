              ...
              <div class="ml-4" >
                <v-list-item-title
                  ...
                  <v-list-item-subtitle>
                    ...
                    <a href="/tentang?tab=highlight" class="primary--text">
              ...
              <v-list>
                ...
                <v-card-actions style="margin-right: 2%">
                  ...
                  <v-btn
                    ...
                    @click="storeItemIbs"
                    class="white--text"
                    :disabled="countRules.length >= 2 && dokumen == true && syarat == true ? false : true"
                  >
                    Iklankan
                  </v-btn>
                </v-card-actions>
              ...
              <v-list>
                ...
                <v-col cols="12" style="margin-top: -2%">
                  ...
                  <v-list-item-group v-model="selected" :multiple="multiple">
                    <v-card v-for="item in unitMokas" :key="item" class="mt-2">
                      <v-list-item
                        :value="item"
                        color="indigo"
                      >
