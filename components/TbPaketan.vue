            ...
            <v-col cols="6">
              <div class="d-flex align-center justify-end">
                {{
                 ...
                 <div class="d-flex align-center justify-end" style="color: #20929D">  ID Iklan: {{ id }} </div>
            </v-col>
          </v-row>
              ...
              <div v-if="iklan.id_app_user == this.userid">
                ...
                <div v-else class="list_penawaran">
                  ...
                  >
                    ...
                    <div>
                      <div
                        class="list_harga hargaz rounded pl-1 pt-1 pr-1 pb-1"
                        style="
                          font-size: 12px;
                          background: #e9f4f5;
                          color: #20929d;
...
export default {
  ...
  async created() {
    ...
    console.log('konfirm auto', this.KonfirmasiAuto)
    console.log('reactivated', this.reactivated)
